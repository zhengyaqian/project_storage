...
parent.$(".nav .container a[name='loopholeRepP.html']").addClass("current");
parent.$(".nav .container a[name='loopholeRepP.html']").siblings().removeClass("current");
parent.$(".footer").show();

document.cookie='page=loopholeRepP.html';
//按钮样式
